...
decoder = Decoder(32, 2048)
extractor.load_state_dict(torch.load('.details/checkpoints/End2End/03-10_14:39:49/Extractor_best.pth'))
encoder.load_state_dict(torch.load('.details/checkpoints/End2End/03-10_14:39:49/Encoder_32_best.pth'))
decoder.load_state_dict(torch.load('.details/checkpoints/End2End/03-10_14:39:49/Decoder_32_best.pth'))